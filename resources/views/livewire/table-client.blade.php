        ...
        <table class="w-full overflow-x-auto text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
            ...
            @foreach($clients as $client)
                <tr class="bg-white dark:bg-gray-800 hover:bg-gray-50 dark:hover:bg-gray-600">
                    ...
                    <td class="px-6 py-4">
                        <img class="w-10 h-10 rounded-full" src="{{ $client->logo }}" alt="{{ $client->name }}">
                    </td>
                    <td class="px-6 py-4">
                        {{$client->name}}
                    </td>
                    ...
                    <td class="px-6 py-4 text-right">
                        <x-dropdown>
                            ...
                            <x-slot name="content">
                                <x-dropdown-link href="{{ route('clients.edit', $client) }}" class="inline-flex">
                                ...
                                <x-dropdown-link href="{{ route('clients.show', $client) }}" class="inline-flex">
                                    <svg class="w-[18px] h-[18px] text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
                                ...
                                <x-dropdown-link href="{{ route('means.index', $client) }}" class="inline-flex">
                                    <svg class="w-[18px] h-[18px] text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
                                ...
                                <x-dropdown-link href="{{ route('public-sessions.index', $client) }}" class="inline-flex">
                                    <svg class="w-[18px] h-[18px] text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
                                        <path stroke="currentColor" stroke-linecap="round" stroke-width="2" d="M4.5 17H4a1 1 0 0 1-1-1 3 3 0 0 1 3-3h1m0-3.05A2.5 2.5 0 1 1 9 5.5M19.5 17h.5a1 1 0 0 0 1-1 3 3 0 0 0-3-3h-1m0-3.05a2.5 2.5 0 1 0-2-4.45m.5 13.5h-7a1 1 0 0 1-1-1 3 3 0 0 1 3-3h3a3 3 0 0 1 3 3 1 1 0 0 1-1 1Zm-1-9.5a2.5 2.5 0 1 1-5 0 2.5 2.5 0 0 1 5 0Z"/>
                                    </svg>
                                    {{ __('Sessões Públicas')}}
                                </x-dropdown-link>
                                <x-dropdown-link href="{{ route('suppliers.index', $client) }}" class="inline-flex">
                                    <svg class="w-[18px] h-[18px] text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
                                ...
                                <x-dropdown-link href="{{ route('clients.destroy', $client) }}" class="inline-flex">
                                    <svg class="w-[18px] h-[18px] text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
