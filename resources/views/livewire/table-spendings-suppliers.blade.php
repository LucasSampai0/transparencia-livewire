    ...
    <div class="relative shadow-md sm:rounded-lg">
        <table class="w-full overflow-x-auto text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
            ...
            @foreach($spendingsSuppliers as $spendingSupplier)
                    ...
                    <td class="px-6 py-4 text-right">
                        <x-dropdown>
                            ...
                            <x-slot name="content">
                                ...
                                <x-dropdown-link  x-on:click="$dispatch('open-modal', {id: '{{$spendingSupplier->id}}'})" class="inline-flex">
                ...
                <x-modal :style="'warning'" name="{{$spendingSupplier->id}}" title="Deseja excluir o fornecedor {{$spendingSupplier->supplier->name}}?">
                    <x-slot:body>
                        <div class="p-3">
                            <p class="text-sm text-gray-700 dark:text-gray-400">
                                Ao excluir o fornecedor {{$spendingSupplier->name}} você estará excluindo todos os dados relacionados a ele. <br>
